...
import { BrainCircuit, Briefcase, Target, GraduationCap, Lightbulb, BookOpen, ChevronRight, Loader2, Compass, CheckCircle2, ListTodo, Route } from 'lucide-react';
...
export default function Home() {
  ...
  const Section: FC<{ icon: React.ReactNode, title: string, description: string, children: React.ReactNode, step: number }> = ({ icon, title, description, children, step }) => (
    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground font-body">
      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto py-8 px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-center font-headline">Your Personalized AI Career Co-Pilot</h1>
          <p className="text-muted-foreground text-center mt-4 text-lg">Navigate your career path with confidence. Let's build your future, one step at a time.</p>
          <Tabs defaultValue="my-path" className="mt-8">
