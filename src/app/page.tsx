...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground font-body">
      ...
      <div className="relative flex flex-col items-center justify-center antialiased bg-background text-center pt-24 md:pt-32 pb-12 md:pb-16">
          <div className="max-w-4xl mx-auto p-4 flex flex-col items-center">
            <Spotlight
              className="-top-40 left-0 md:left-60 md:-top-20"
            />
             <h1 className="text-6xl md:text-8xl font-bold text-foreground relative z-20 pb-4">
                NextStep
             </h1>
            <h2 className="relative z-10 text-5xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/70 font-sans font-bold">
